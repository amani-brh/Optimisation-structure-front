    ...
    <div className="mod-page">
      ...
      <div className="mod-grid-2">
        <div className="mod-card">
          ...
          <div className="mod-field">
            ...
            <input type="number" className="mod-field-input" defaultValue={20} />
          ...
          <div className="mod-field">
            ...
            <input type="number" className="mod-field-input" defaultValue={6} />
            <div className="mod-field-unit">mètres au niveau de l'about</div>
          </div>
          <div className="mod-field">
            <label className="mod-field-label">Hauteur au faîtage h₂</label>
        ...
        <div className="mod-card">
          ...
          <div className="mod-field">
            ...
            <select className="mod-field-select">
              ...
              <option defaultValue="selected">CC2 — Normal</option>
      ...
      <div className="mod-grid-4">
        <div className="mod-metric">
          ...
          <div className="mod-metric-value">20.0</div>
        ...
        <div className="mod-metric">
          ...
          <div className="mod-metric-value">6.0</div>
          <div className="mod-metric-unit">mètres</div>
        </div>
        <div className="mod-metric">
